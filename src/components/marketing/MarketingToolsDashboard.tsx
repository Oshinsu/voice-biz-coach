    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="porter" className="w-full">
        ...
        <TabsContent value="marketing" className="space-y-6">
          <div className="p-6 text-center">
            <p className="text-muted-foreground">
              Les informations marketing détaillées sont maintenant intégrées dans l'onglet "Vue d'ensemble".
            </p>
          </div>
        </TabsContent>
      </Tabs>
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  Déploiement immédiat + formation équipe
                </li>
                <li className="flex items-center gap-2">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  +25% engagement étudiant visé
                </li>
                <li className="flex items-center gap-2">
                  <BarChart3 className="h-3 w-3 text-cyan-600" />
                  ROI pédagogique mesurable via analytics VNS
                </li>
              </ul>
            </div>
          </div>
